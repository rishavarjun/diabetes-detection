...
def init():
    ...
    inputs_dc = ModelDataCollector("diabetes-detection-master", designation="inputs", feature_names=["feat1", "feat2", "feat3", "feat4", "f5", "f6", "f7", "f8"])
    prediction_dc = ModelDataCollector("diabetes-detection-master", designation="predictions", feature_names=["prediction"])
